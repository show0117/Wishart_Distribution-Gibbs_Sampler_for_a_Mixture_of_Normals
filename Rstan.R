...
n.chains=3
len = 500
sims=array(NA, c(len, n.chains, 14))
dimnames(sims)=list(NULL, NULL, 
                    c("mu1.1","mu1.2","mu2.1","mu2.2",
                      'sigma1.1.1','sigma1.2.1','sigma1.1.2',
                      'sigma1.2.2','sigma2.1.1','sigma2.1.2',
                      'sigma2.2.1','sigma2.2.2','alpha1',
                      'alpha2'))
...
for (chain in 1:n.chains){
  ...
  for (colname in colnames(data)){
    sims[,chain,colname] = data[colname][502:1001,]
  }
  print(chain)
}

round(monitor(sims),3)
