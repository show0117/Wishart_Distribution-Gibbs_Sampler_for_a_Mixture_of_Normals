...
data_Gibbs <- data.frame('mu1.1'=mu[1,1],'mu1.2'=mu[2,1],
...
for(i in 1:n_iter){
  ...
  data_Gibbs = rbind(data_Gibbs,new_data)
  print(i)
}

for (i in colnames(data_Gibbs)){
  dt = data_Gibbs[i][52:101,]
  print(i)
  print(mean(dt))
  #print(var(dt))
}

ts.plot(data_Gibbs$mu1.1[1:100])

x =  c(1:100)
y = data_Gibbs$mu1.1[1:100]
y2 = data_EM$mu1.1[1:100]
plot(x,y,type = "l")
lines(x,y2,col = 'blue')
